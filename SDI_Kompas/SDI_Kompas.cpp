...
// SDI_Kompas.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CSDIKompasApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CSDIKompasApp::OnAppAbout)
...
// Создание CSDIKompasApp

CSDIKompasApp::CSDIKompasApp() noexcept
{
	...
	SetAppID(_T("SDIKompas.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CSDIKompasApp

CSDIKompasApp theApp;


// Инициализация CSDIKompasApp

BOOL CSDIKompasApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CSDIKompasDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CSDIKompasView));
	if (!pDocTemplate)
		return FALSE;
...
int CSDIKompasApp::ExitInstance()
{
...
// Обработчики сообщений CSDIKompasApp
