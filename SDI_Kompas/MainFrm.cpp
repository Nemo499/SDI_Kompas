...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	m_wndSplitter.CreateView(0, 1, RUNTIME_CLASS(CSDIKompasView), CSize(0, 0), pContext);

	SetActiveView((CView*)m_wndSplitter.GetPane(0, 1));

	((CSDIKompasDoc*)GetActiveDocument())->pTree = (CMyTreeView*)m_wndSplitter.GetPane(0, 0);
	((CSDIKompasDoc*)GetActiveDocument())->pView = (CSDIKompasView*)m_wndSplitter.GetPane(0, 1);
	
	((CMyTreeView*)m_wndSplitter.GetPane(0, 0))->m_pDoc = ((CSDIKompasDoc*)GetActiveDocument());
